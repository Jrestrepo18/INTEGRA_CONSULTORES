...
const Clients = () => {
    ...
    // Iconos para sectores
    const sectorIcons = [Factory, Landmark, ShoppingBag, Building2, Leaf, Briefcase];
    const translatedSectors = tObj('clients.sectors.detailedList') || [];
        ...
        <section className="bg-[#02010a] min-h-screen border-t border-white/5 pb-32 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 pt-24 relative z-10">
                ...
                <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.4em] text-slate-500 mb-12">
                    ...
                    <span>/</span>
                    <span className="text-[#c5a67c]">{t('clients.title')}</span>
                </div>
                ...
                <Reveal>
                    <div className="mb-32">
                        <div className="inline-flex items-center gap-3 px-3 py-1 bg-[#c5a67c]/10 border border-[#c5a67c]/20 rounded-full mb-8">
                            ...
                            <span className="text-[#c5a67c] text-[9px] font-black uppercase tracking-[0.3em]">{t('clients.badge')}</span>
                        </div>
                        <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-10 tracking-tighter leading-none">
                            {t('clients.subtitle').split('.')[0]}. <br /> <span className="text-[#c5a67c]">{t('clients.subtitle').split('.')[1] || ''}</span>
                        </h2>
                ...
                <div className="mb-40">
                    <Reveal>
                        <div className="text-center mb-24">
                            <span className="text-[#c5a67c] text-[10px] font-black uppercase tracking-[0.5em] mb-4 block">{t('clients.sectors.badge')}</span>
                            <h3 className="text-3xl md:text-6xl font-bold text-white tracking-tight">{t('clients.sectors.title')}</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {translatedSectors.map((sector, index) => {
                            const Icon = sectorIcons[index] || Briefcase;
                            return (
                                <Reveal key={index} delay={index * 100}>
                                    <div className="p-10 bg-white/5 border border-white/5 hover:border-[#c5a67c]/30 transition-all duration-500 group">
                                        <Icon className="text-[#c5a67c] mb-8 group-hover:scale-110 transition-transform" size={32} strokeWidth={1.2} />
                        ...
                        <div>
                            <Reveal>
                                <div className="inline-flex items-center gap-3 px-4 py-2 bg-[#c5a67c]/10 border border-[#c5a67c]/20 rounded-full text-[#c5a67c] text-[9px] font-black uppercase tracking-[0.3em] mb-6">
                                    <Handshake size={14} /> {t('clients.partners.badge')}
                                </div>
                                <h3 className="text-3xl md:text-5xl font-bold text-white mb-8 tracking-tight leading-tight">
                                    {t('clients.partners.title').split('.')[0]}. <br /> <span className="text-[#c5a67c]">{t('clients.partners.title').split('.')[1] || ''}</span>
                                </h3>
                                    ...
                                    <div className="absolute bottom-0 left-0 w-full z-20">
                                        <div className="bg-[#02010a]/95 backdrop-blur-xl p-5 border-t border-[#c5a67c]/30 flex items-center justify-between">
                                            <div>
                                                ...
                                                <div className="text-[8px] uppercase font-black tracking-widest text-[#c5a67c]">{t('clients.confidentiality')}</div>
                                            </div>
                ...
                <Reveal delay={200}>
                    <div className="relative py-16 px-8 md:p-20 rounded-sm text-center bg-gradient-to-br from-[#0f2a4a] to-[#02010a] border border-white/10 shadow-2xl overflow-hidden group">
                        ...
                        <div className="relative z-10 max-w-4xl mx-auto">
                            ...
                            >
                                {t('clients.helpSection.btn')} <MessageCircle size={16} />
                            </Link>
                        </div>
                    </div>
                </Reveal>
